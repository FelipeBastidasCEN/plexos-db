...
from ..business.services.config_service import ConfigService
        ...
        try:
            ...
            with ZipFile(self.args.input) as zf:
                ...
                if self.args.xml_name not in file_list:
                    self._print_error(f"Archivo XML no encontrado en ZIP: {self.args.xml_name}")
                    return 1
                ...
                with zf.open(self.args.xml_name, "r") as f:
                    ...
                    if unknown:
                        ...
                        self._print(f"✅ Tablas soportadas: {[t for t in table_tags if t in supported]}")
                    else:
